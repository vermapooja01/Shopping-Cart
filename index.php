...
<div class="txt-heading">Your Cart <a id="btnEmpty" href="index.php?action=empty">Empty Your Cart</a></div>
<?php
...
<th style="text-align:cneter;"><strong>Code</strong></th>
...
<div id="product-grid">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM tblproduct ORDER BY id");
